...
module.exports = {
  ...
  devAppBuild: resolveApp(devPath),
...
if (
  ...
  module.exports = {
    ...
    devAppBuild: resolveApp(path.join('../..', devPath)),
    ...
    appIndexJs: resolveModule(resolveOwn, `${templatePath}/src/popup/index`),
    appBackgroundJs: resolveModule(resolveOwn,`${templatePath}/src/background/index`),
    appContentScriptJs: resolveModule(resolveOwn,`${templatePath}/src/contentScript/index`),
    appOptionsJs: resolveModule(resolveOwn,`${templatePath}/src/options/index`),
